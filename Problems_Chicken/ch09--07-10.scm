...
;; ----------------------------------------------
;; 9.7 Write function letterwords that takes a letter and a sentence and
;; returns a sentence with only the words containing the letter.
...
;; ----------------------------------------------
;; 9.8 Write a display function for a game of hangman that takes a word and the
;; letters guessed so far by the player. Display the word with blanks
;; (underscores) in the positions not exposed by the player guesses.
...
;; ----------------------------------------------
;; 9.9 Write function `common-words' that takes two sentences and returns a
;; sentence containing only items common to both.
;;
;; `member?' will get the job done. The check for list length isn't really
;; needed, but it feels more efficient.
;;
...
;; ----------------------------------------------
;; 9.10 Implement `appearances' from chapter two. How many times does the first
;; argument appear in the second? This is a variation of the `character-count'
;; problem from chapter 8.
